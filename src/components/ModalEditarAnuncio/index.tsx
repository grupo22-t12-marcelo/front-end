...
const EditarAnuncio = () => {
  ...
  const { setIsModalEditAnuncio } = useContext(ProductContext);
      ...
      <Modal>
        ...
        <Form>
          ...
          <InformacoesVeiculo>
            ...
            <div className="div-informacoes">
              ...
              <div className="div-dados-veiculo">
                ...
                <label>
                  <span>{tipo === "Venda" ? "Preço" : "Lance inícial"}</span>
          ...
          <div className="buttons">
            <Button className="cancelar" onClick={() => setIsModalEditAnuncio(false)}>Cancelar</Button>
